...
class StructureDraggableList
  ...
  @override
  State<
    StructureDraggableList
  >
  createState() => _StructureDraggableListState();
}

class _StructureDraggableListState
    extends
        State<
          StructureDraggableList
        > {
  ...
  void initState() {
    super.initState();
    _structure = List.from(
      widget.initialStructure,
    );
  }
      ...
      builder:
          (
            ...
            actions: [
              ...
              TextButton(
                onPressed: () {
                  if (newBlockController.text.trim().isNotEmpty) {
                    setState(
                      () {
                        _structure.add(
                          newBlockController.text.trim(),
                        );
                      },
                    );
                ...
                (
                  ...
                  setState(
                    () {
                      ...
                      final String item = _structure.removeAt(
                        oldIndex,
                      );
                      _structure.insert(
                        newIndex,
  ...
  Widget _buildBlockTile(
    ...
    return Card(
      key: ValueKey(
        '$title$index',
      ), // Chave única para o ReorderableListView
      color: const Color(
        0xFF1A1A1A,
      ),
      ...
      elevation: 3,
      shadowColor: widget.activeColor.withValues(
        alpha: 0.1,
      ),
