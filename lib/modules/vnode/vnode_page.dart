...
class VNodePage
  ...
  State<
    VNodePage
  >
  createState() => _VNodePageState();
}

class _VNodePageState
    extends
        State<
          VNodePage
        > {
  ...
  _posts = [
    {
      ...
      "comments": [
        {
          "author": "Joao_Vitor",
          "text": "Esse drop no começo ficou absurdo!",
          "timestamp": "00:15",
        },
        {
          "author": "Yuki_Trap",
          "text": "O 808 tá batendo limpo demais aqui",
          "timestamp": "01:02",
        },
        {
          "author": "Rhymer_01",
          "text": "Mandei uma rima nessa parte e encaixou certinho",
          "timestamp": "01:45",
        },
      ],
    },
    {
      ...
      "comments": [
        {
          "author": "Pedro_Beats",
          "text": "Gostei da ambição desse refrão",
          "timestamp": "00:48",
        },
      ],
    },
  ...
  void initState() {
    ...
    for (var post in _posts) {
      ...
      _selectedTimestamps[post["id"]] = "00:00";
    }
  }
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSectionTitle(
              "Feed VNode • Últimos Lançamentos",
            ),
            ListView.separated(
              shrinkWrap: true,
          ...
          Expanded(
            child: Column(
              ...
              children: const [
                ...
                Text(
                  "Suba seu arquivo .mp3 ou .wav na rede VNode",
                  style: TextStyle(
              ...
              >(
                ...
                onSelected:
                    (
                      ...
                      setState(
                        () => _selectedTimestamps[postId] = value,
                      );
                    },
                child: Container(
                  padding: const EdgeInsets.symmetric(
