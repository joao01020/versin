...
// ============================================================
//
// Esta página deve ser exibida SOMENTE depois que o AuthWrapper
// detectar uma sessão válida de recuperação do Supabase.
//
// Ela NÃO:
//
// - escolhe redirect;
// - processa deep link;
// - conhece Web ou Desktop;
...
// - receber nova senha;
// - confirmar senha;
// - chamar PasswordRecoveryController;
...
//   ↓
// PasswordRecoveryService.updatePassword()
//
// ============================================================
...
class _ResetPasswordPageState extends State<ResetPasswordPage> {
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: const Icon(Icons.check_rounded, color: accentNeon, size: 32),
          ),
  ...
  Future<void> _submit() async {
    ...
    debugPrint(
      '[RESET PASSWORD PAGE] '
      'Senha atualizada. Aguardando confirmação do usuário.',
    );
  }
