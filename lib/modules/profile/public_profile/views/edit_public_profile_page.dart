...
import 'package:versin/modules/profile/public_profile/widgets/edit_profile_avatar_widget.dart';
...
class EditPublicProfilePage
  ...
  >
  createState() => _EditPublicProfilePageState();
}
...
class _EditPublicProfilePageState
    extends
        State<
          EditPublicProfilePage
        > {
  ...
  void _handleAvatarTap() {
    ScaffoldMessenger.of(
      ...
      ..showSnackBar(
        const SnackBar(
          content: Text(
            'Seleção de avatar será conectada na próxima etapa.',
          ),
        ),
      );
  }
        ...
        child: Column(
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: _inputDecoration(
                hint: 'Conte sobre você, seu trabalho, estilo musical e o que procura no Versin.',
