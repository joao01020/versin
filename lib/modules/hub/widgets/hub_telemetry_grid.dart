        ...
        Row(
          children: [
            _buildStatCard(
              ...
              subtitleWidget: Text(
                online
                    ? 'Sensor térmico operational'
                    : 'Sensor térmico interno offline',
                style: const TextStyle(
                  color: Colors.white24,
                  fontSize: 10,
                ),
            ...
            _buildStatCard(
              ...
              subtitleWidget: Text(
                online
                    ? 'SPIFFS montada com sucesso'
                    : 'Partição SPIFFS desmontada',
                style: const TextStyle(
                  color: Colors.white24,
                  fontSize: 10,
                ),
