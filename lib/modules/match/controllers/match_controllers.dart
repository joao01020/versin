...
class MatchController
  ...
  registerLike(
    ...
    try {
      ...
      //
      // Portanto a mesma pessoa não pode curtir o mesmo perfil
      // mais de uma vez.
      //
      // ========================================================
      ...
      // ========================================================
      //
      // Isso é importante quando o usuário atual é o SEGUNDO a
      // curtir.
      //
      // Exemplo:
      //
      ...
      // A curte B agora
      //
      // O listener de A observa target_user_id = A e não receberia
      // a nova linha A -> B.
      //
      // Por isso verificamos aqui também.
      //
      // ========================================================
      ...
      if (error.code ==
        ...
        // ======================================================
        // AINDA VERIFICAR MATCH
        // ======================================================
        //
        // Mesmo que o like já exista, o outro usuário pode ter
        // curtido depois.
        //
        // ======================================================
