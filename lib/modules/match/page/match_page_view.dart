...
import 'package:versin/modules/match/page/widgets/match_locked_interaction.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            ConnectionProfileCardWidget(
              ...
              onEditProfile: () {
                return coordinator.openProfessionalProfileSettings(context);
              },
            ),

            const SizedBox(height: 10),

            MatchLockedInteraction(
