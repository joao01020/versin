...
class ProfileTrackPlayerController
    extends
        ChangeNotifier {
  // ============================================================
  // PLAYER
  ...
  static const Duration previewLimit = Duration(
    seconds: 60,
  );
  ...
  String get formattedPosition => _formatDuration(
    _position,
  );

  String get formattedDuration => _formatDuration(
    _effectiveDuration,
  );
  ...
  load({
    ...
    try {
      ...
      _setError(
        'O carregamento da demo foi interrompido.',
      );
  ...
  void _setupStreams() {
    ...
    _errorSubscription = _player.errorStream.listen(
      (
        ...
        _setError(
          'A reprodução da demo foi interrompida.',
        );
