...
class HubPanelPage extends StatefulWidget {
  const HubPanelPage({super.key});

  @override
  State<HubPanelPage> createState() => _HubPanelPageState();
}

class _HubPanelPageState extends State<HubPanelPage> {
  ...
  Widget _buildConsoleRowItem({
    ...
    final bool isSelected = currentActiveMode == modeKey;
    ...
    return AnimatedSize(
      ...
      child: Column(
        children: [
          GestureDetector(
            onTap: () => _controller.sendCommandToHub(command, modeKey),
            child: Container(
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: TextField(
                            controller: _controller.walletController, // Utilizando o controller unificado da lógica
                            style: TextStyle(
                              color: hackerGreen,
                              fontFamily: 'Courier',
                              fontSize: 13,
