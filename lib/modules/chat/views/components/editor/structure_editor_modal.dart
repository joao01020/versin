...
class StructureEditorModal {
  static void show({
    ...
    List<
      String
    >
    estruturaLista = initialStructure
        .split(
          ', ',
        )
        .map(
                                      ...
                                      setModalState(
                                        () {
                                          if (newIdx >
                                              oldIdx)
                                            newIdx -= 1;
                                          final item = estruturaLista.removeAt(
                                            oldIdx,
                                          );
                                          estruturaLista.insert(
                                            newIdx,
                                            item,
                                          );
                                        },
                              ...
                              Expanded(
                                child: ElevatedButton(
                                  style: ElevatedButton.styleFrom(
                                    ...
                                    elevation: 8,
                                    shadowColor: activeColor.withValues(
                                      alpha: 0.3,
                                    ),
                                  ),
                                  onPressed: () {
