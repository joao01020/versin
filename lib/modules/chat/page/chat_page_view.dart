...
// A implementação visual/interaction layer foi movida para page/.
// A API pública continua em views/chat_page.dart.
//
// Próximas subdivisões podem ser feitas por feature sem alterar a rota pública.
...
import 'package:versin/modules/chat/views/components/chat/input/chat_bottom_bar.dart';
import 'package:versin/modules/chat/views/components/editor/structure_editor_modal.dart';
import 'package:versin/modules/chat/views/components/editor/studio_toolbar.dart';
import 'package:versin/modules/chat/views/components/header/chat_header.dart';
import 'package:versin/modules/chat/views/widgets/audio/voice_studio_panel.dart';
...
class _ChatPageViewState extends State<ChatPageView>
  ...
  Future<void> _initializeChat() async {
    ...
    // O cache local da quota já preenche a UI. A atualização real
    // deixa de bloquear a abertura da página.
    unawaited(_refreshAiQuota(chatRepository));
