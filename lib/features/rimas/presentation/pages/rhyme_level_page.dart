...
class _RhymeLevelPageState extends State<RhymeLevelPage> {
  ...
  // Mapa de subcategorias automáticas
  final Map<String, List<String>> subGenres = {
    'Trap': ['Padrão', 'Emo Trap', 'Drill', 'Agressivo', 'Melódico'],
    'Rap': ['Padrão', 'Boom Bap', 'Old School', 'Hardcore'],
    'Sertanejo': ['Padrão', 'Universitário', 'Modão', 'Arrocha'],
    'Samba/Pagode': ['Padrão', 'Partido Alto', 'Romântico', 'Raiz'],
    'Forró': ['Padrão', 'Piseiro', 'Xote', 'Eletrônico'],
  };
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          // Seleção de Gênero Principal
          _buildDropdown(
            label: "Gênero Musical",
            value: selectedGenre,
            items: ['Automático', 'Trap', 'Rap', 'Sertanejo', 'Samba/Pagode', 'Forró'],
            onChanged: (val) {
              setState(() {
                selectedGenre = val!;
          ...
          // Subcategoria Dinâmica (Aparece se o gênero tiver subcategorias mapeadas)
