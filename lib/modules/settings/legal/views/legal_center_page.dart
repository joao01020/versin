...
class LegalCenterPage extends StatelessWidget {
              ...
              child: Column(
                ...
                children: [
                  ...
                  _card(
                    children: [
                      _tile(
                        ...
                        subtitle:
                            'Como o Versin trata dados, privacidade e retenção.',
                        onTap: () => _openDocument(
                          context,
                          title: 'Política de Privacidade',
                      ...
                      _tile(
                        ...
                        title: 'Termos de Uso',
                        subtitle:
                            'Regras para uso da conta, conteúdos e recursos.',
                        onTap: () => _openDocument(
                          context,
                          title: 'Termos de Uso',
                      ...
                      _tile(
                        ...
                        subtitle:
                            'Licenças dos pacotes e bibliotecas utilizados.',
                        onTap: () {
                          showLicensePage(
                            context: context,
                  ...
                  _card(
                    children: [
                      ...
                      _tile(
                        ...
                        subtitle:
                            'Como a arquitetura protege conta, dados e operações.',
                        onTap: () => _openDocument(
                          context,
                          title: 'Segurança e privacidade',
                  ...
                  _card(
                    children: [
                      _tile(
                        ...
                        subtitle:
                            'Abrir controles de dados pessoais e exclusão da conta.',
                        danger: true,
                        onTap: () {
                          Navigator.of(context).push(
                            MaterialPageRoute<void>(
                  ...
                  _card(
                    children: [
                      _tile(
                        ...
                        title: 'Créditos',
                        subtitle:
                            'Tecnologias, software livre e agradecimentos.',
                        onTap: () => _openDocument(
                          context,
                          title: 'Créditos',
                  ...
                  Container(
                    ...
                    child: const Text(
                      'Os textos legais incluídos nesta versão são uma base técnica '
                      'para o produto e devem receber revisão jurídica antes de uma '
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [_purple.withValues(alpha: 0.38), _surface],
        ),
  ...
  Widget _card({required List<Widget> children}) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: _surface.withValues(alpha: 0.76),
  ...
  Widget _tile({
    ...
    return ListTile(
      ...
      leading: Container(
        ...
        child: Icon(icon, color: danger ? Colors.redAccent : _accent, size: 20),
      ),
      title: Text(
        title,
        style: TextStyle(
  ...
  Widget _divider() {
    return Divider(color: Colors.white.withValues(alpha: 0.055), height: 1);
  }
  ...
  void _openDocument(
    ...
    Navigator.of(context).push(
      MaterialPageRoute<void>(
        builder: (_) => LegalDocumentPage(title: title, markdown: content),
      ),
    );
  }
}
