...
class MasterSearchCard extends StatelessWidget {
                        ...
                        child: GestureDetector(
                          onTap: () {
                            if (state == SearchState.searching) {
                              ...
                              if (controller.forceOffline.value) {
                                ...
                                controller.startActiveHardwareSearch(online);
                              }
                            }
                          },
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                if (controller.isGlobalSearching.value || state == SearchState.found)
                                  BoxShadow(
...
class RadarPulsePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Paint paint = Paint()
      ..color = pulseColor.withOpacity(opacity * 0.15)
