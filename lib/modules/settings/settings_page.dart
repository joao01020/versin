...
class _SettingsPageState extends State<SettingsPage> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSectionTitle("Perfil do Produtor"),
                ...
                children: [
                  ListTile(
                    leading: CircleAvatar(
                      ...
                      child: Icon(Icons.person, color: accentNeon),
                    ),
                    title: const Text("Informações da Conta", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                    subtitle: const Text("Editar e-mail, nome de usuário e avatar", style: TextStyle(color: Colors.white54, fontSize: 12)),
            ...
            // SEÇÃO: HARDWARE & INTEGRAÇÕES
            _buildSectionTitle("Integrações & Hardware"),
            _buildSettingsContainer(
              child: Column(
                children: [
                  ListTile(
                    leading: Icon(Icons.settings_input_component, color: accentNeon, size: 22),
                    title: const Text("Versin Hub Config", style: TextStyle(color: Colors.white)),
                    subtitle: const Text("Gerenciar conexões de hardware externo", style: TextStyle(color: Colors.white54, fontSize: 12)),
                    trailing: const Icon(Icons.arrow_forward_ios, color: Colors.white24, size: 16),
                    onTap: () {},
                  ),
                  _buildDivider(),
                  
                  // ITEM DA API EXPANSÍVEL
                  Theme(
                    ...
                    child: ExpansionTile(
                      ...
                      leading: Icon(Icons.vpn_key_outlined, color: accentNeon, size: 22),
                      title: const Text("Configurar API Privada", style: TextStyle(color: Colors.white)),
                      subtitle: const Text("Gerenciar credenciais e chaves externas de IA/Serviços", style: TextStyle(color: Colors.white54, fontSize: 12)),
                      trailing: Icon(
                        _isApiExpanded ? Icons.keyboard_arrow_up : Icons.keyboard_arrow_down,
            ...
            // SEÇÃO: CRIPTOGRAFIA & CONTA
            _buildSectionTitle("Segurança & Criptografia"),
            _buildSettingsContainer(
              child: Column(
                children: [
                  ListTile(
                    leading: const Icon(Icons.vpn_key, color: Colors.white60, size: 22),
                    title: const Text("Gerenciar Par de Chaves", style: TextStyle(color: Colors.white)),
                    subtitle: const Text("Backup e rotação das chaves públicas e privadas da rede", style: TextStyle(color: Colors.white54, fontSize: 12)),
                    trailing: const Icon(Icons.arrow_forward_ios, color: Colors.white24, size: 16),
                    onTap: () {},
                  ),
                  _buildDivider(),
  ...
  // WIDGET AUXILIAR: CONTAINER ESTILIZADO EM CONTAINER TRANSLÚCIDO
  ...
  // WIDGET AUXILIAR: SWITCH PERSONALIZADO
  Widget _buildSwitchTile({
    ...
    return SwitchListTile(
      ...
      activeTrackColor: primaryPurple.withOpacity(0.4),
