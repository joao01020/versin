...
class ChassiComponentsList
  ...
  _hardwareComponents = [
    {
      "name": "Anel de Feedback LED (NeoPixel)",
      "icon": Icons.blur_circular_outlined,
      "desc": "Sinalização visual de BPM e gravação",
    },
    {
      "name": "Sensores Touch Capacitivos",
      "icon": Icons.touch_app_outlined,
      "desc": "Atalhos rápidos e controle gestual de efeitos",
    },
    {
      "name": "Cápsula de Microfone (I2S)",
      "icon": Icons.mic_none_outlined,
      "desc": "Captação analógica e conversão digital de rimas",
    },
    {
      "name": "Matriz de Teclas Mecânicas",
      "icon": Icons.keyboard_alt_outlined,
      "desc": "Gatilhos rápidos para modo Studio e Rhyme",
    },
    {
      "name": "Display Gráfico OLED 128x64",
      "icon": Icons.screenshot_monitor,
      "desc": "Retorno visual de metadados e espectro de áudio",
    },
  ];
          ...
          children: [
            Column(
              ...
              children: [
                ...
                const Text(
                  "Componentes e transdutores integrados de fábrica",
                  style: TextStyle(
