...
enum UserRole { artist, beatmaker }

enum ConnectionType { chat, video, proximity }
...
class MatchUserEntity {
  ...
  MatchUserEntity copyWith({
    ...
    return MatchUserEntity(
      ...
      tags: tags ?? this.tags,
      bio: bio ?? this.bio,
      showcaseMediaUrl: showcaseMediaUrl ?? this.showcaseMediaUrl,
      showcaseDescription: showcaseDescription ?? this.showcaseDescription,
      distanceKm: distanceKm ?? this.distanceKm,
      isOnline: isOnline ?? this.isOnline,
      preferredConnection: preferredConnection ?? this.preferredConnection,
      sessionStartedAt: sessionStartedAt ?? this.sessionStartedAt,
      provisionalHash: provisionalHash ?? this.provisionalHash,
    );
  }
}