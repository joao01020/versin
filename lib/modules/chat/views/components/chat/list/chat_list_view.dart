          ...
          Container(
            ...
            child: SizedBox(
              ...
              child: CircularProgressIndicator(
                strokeWidth: 2,
                valueColor: AlwaysStoppedAnimation<Color>(activeColor.withOpacity(0.4)),
              ),
            ),
          ),
...
class NeonGlintText extends StatefulWidget {
  final String text;
  ...
  @override
  State<NeonGlintText> createState() => _NeonGlintTextState();
}

class _NeonGlintTextState extends State<NeonGlintText> with SingleTickerProviderStateMixin {
